...
async def gen_cards(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await update.message.reply_text("Generated Cards:\n" + "\n".join(generated_cards))
...
⊗ Country: {country} {emoji}
        ...
        await update.message.reply_text("Error checking card info.")
...
⊗ Checked By ➜ ------{user.first_name.upper()} ☠️
        ...
        await update.message.reply_text("Error fetching BIN data.")
